...
HD_PWD='C:/Users/LABAdmin/BRAMNN/BRAMNN.runs/FCLW1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FCLW1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FCLW1.tcl
